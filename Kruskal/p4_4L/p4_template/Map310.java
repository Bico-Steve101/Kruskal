...
class Map310<K extends Comparable<? super K>,V> implements Map<K,V> {
	...
	*/
	...
	/**
	* collects and returns a Set of keys contained in this map.
	* @return a Set of keys contained in this map. If the map is empty, an empty Set is returned.
	*/
	public Set<K> keySet() {
		Set310<K> keySet = new Set310<>(); // set to hold keys
		if (storage.isEmpty()){// map is empty
			return keySet;
		}

		LinkedList<Pair> data = storage.values(); //linked list conating all values
		for (Pair pair : data) {//iterates through the linked list and adds all key values to set
	...
	/**
	* collects and returns a Collection of values contained in this map.
	*
	* @return a Collection of values contained in this map. If the map is empty, an empty LinkedList is returned.
	*/
	public Collection<V> values() {
		...
		for (Pair pair : data) { //iterates through the linked list and adds all values to set
